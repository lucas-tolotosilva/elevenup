...
export function Healthcare ({color}: colorProps){
    
    return (
           <div className="w-full h-full flex flex-col justify-center relative">
                <div className="w-full h-full z-0">
                    <div className={`w-[400px] h-[400px] -mr-[150px] -mb-[150px] right-0  bottom-0 absolute rounded-full ${color}`}>
                    </div>
                </div>
                <div className="text-justify z-20 rounded-3xl font-default text-[18px] pr-14 pl-14 py-14 bg-white-gradient">
                    ...
                    <div className="mb-7">
                        <h6 className="font-bold">Utilizamos Ciência e Inovação!</h6>
                    </div>
                    
                    <div>
                        <h6 className="font-bold">Nossos segmentos:</h6>
...
export function Lifescience ({color}: colorProps){
    return (
        <div className="w-full h-full flex flex-col justify-center relative">
            <div className="w-full h-full z-0">
                <div className={`w-[400px] h-[400px] -mr-[150px] -mb-[150px] right-0  bottom-0 absolute rounded-full ${color}`}>
