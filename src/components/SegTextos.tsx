...
export function Healthcare (){
    ...
    return (
           <div className="w-full sm:pb-10 h-full flex flex-col justify-center relative ">
                ...
                <div className="text-justify z-20 rounded-3xl font-default text-[18px] sm:px-8 lg:px-14 lg:py-14 lg:bg-white-gradient">
                    <div className="mb-7">
                        <h3 className="font-title sm:text-[30px] sm:text-center sm:mt-10 lg:text-6xl">Healthcare</h3>
                    </div>
                    <div className="mb-7">
                        <p className=" sm:text-[14px] lg:text-[18px]">
                    ...
                    <div className="mb-7">
                        <h6 className="font-bold sm:text-center sm:text-[17px]">Utilizamos Ciência e Inovação!</h6>
                    </div>
                    
                    <div>
                        <h6 className=" sm:text-[17px] font-bold">Nossos segmentos:</h6>
                        <ul className="sm:text-[14px] list-disc ml-10 sm:mt-4">
...
export function Lifescience (){
    return (
        <div className="w-full h-full sm:pb-10 flex flex-col justify-center relative">
            ...
            <div className="text-justify z-20 rounded-3xl font-default text-[18px] sm:px-8 lg:px-14 lg:py-14 lg:bg-white-gradient">
                <div className="mb-7">
                    <h3 className="font-title sm:text-[30px] sm:mt-10 text-center lg:text-6xl">Life Science</h3>
                </div>
                <div className="mb-7">
                    <p className="sm:text-[14px] lg:text-[18px]">
                ...
                <div className="mb-7">
                    <h6 className="font-bold sm:text-[17px] text-center">Utilizamos Ciência e Inovação!</h6>
                </div>

                <div>
                    <h6 className="font-bold sm:text-[17px] sm:mb-4">Nossos segmentos:</h6>
                    <ul className="list-disc ml-10 sm:text-[14px]">
