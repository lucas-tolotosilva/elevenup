...
export function Clientes () {
    ...
    return (
        <div className="w-full mb-36">
            <motion.h2 
                className="font-title w-full lg:text-[150px] sm:text-[50px] mb-24"
            ...
            <Parallax speed={10} translateY={[0 ,0]} translateX={[-120, -80]}>
            ...
            <Parallax translateY={[0 ,0]} translateX={[-80, -120]}>
                <motion.div 
