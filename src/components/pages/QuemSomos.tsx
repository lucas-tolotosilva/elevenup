...
export function QuemSomos(){
    ...
    <div className="bg-gray-200 overflow-x-hidden">
            <div className="relative w-screen min-h-screen flex flex-col items-center justify-center text-center mb-56 ">
            <Nav />
            
            <div className="max-w-[1280px] bg-gray-200 absolute top-40">
                <h1 className="font-title tracking-wider mb-24   font-bold text-[150px]">quem somos</h1>
                <div className="flex justify-end  items-center">
                    <img className="w-1/2 cover rounded-3xl" src={img1} />
                    <div className="text-justify pl-44 py-10 rounded-full -ml-52 bg-gray-200 ">
                        <p>
            ...
            <div className="w-screen bg-black-900 h-64 text-white-100 font-default text-[40px] flex justify-center items-center mb-56">
