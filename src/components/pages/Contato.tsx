            ...
            <div className="relative w-screen min-h-screen flex flex-col items-center justify-center text-center ">
                ...
                <div className="max-w-[1280px] bg-gray-200 mt-40">
                    ...
                    <div className="w-full flex flex-wrap overflow-hidden">
                        ...
                        <form>
                            <div className="sm:w-full lg:w-[1000px] flex justify-center items-center rounded-3xl overflow-hidden  bg-white-100">
                                ...
                                <div className="sm:w-full lg:w-1/2 px-14 py-14 font-default text-blue-800 text-[18px] bg-white-80">
                                    <div className="relative my-10">
                                        ...
                                        <span className={`${focus ? '-translate-y-[32px] text-[16px]' : null} transition-all duration-400 absolute py-2 left-0 pointer-events-none`}>{focus ? 'Nome' : nome == '' ? 'Nome' : null}</span>
                                    ...
                                    <div className="relative my-10">
                                        ...
                                        <span className={`${focus3 ? '-translate-y-[32px] text-[16px]' : null} transition-all duration-400 absolute py-2 left-0 pointer-events-none`}>{focus3 ? 'Email' : email == '' ? 'Email' : null}</span>
                                        <i className={`absolute bottom-0 left-0 w-full text-white-100 bg-blue-50 z-10 ${focus3 ? 'h-full' : 'h-[2px] '} rounded-lg transition-all ease-in-out duration-400`}></i>
                                    </div>
                                    <div className="relative my-10">
                                        ...
                                        <span className={`${focus4 ? '-translate-y-[32px] text-[16px]' : null} transition-all duration-400 absolute py-2 left-0 pointer-events-none`}>{focus4 ? 'Mensagem' : msg == '' ? 'Mensagem' : null}</span>
                                        <i className={`absolute bottom-0 left-0 w-full text-white-100 bg-blue-50 z-10 ${focus4 ? 'h-full' : 'h-[2px] '} rounded-lg transition-all ease-in-out duration-400`}></i>
                                    </div>
